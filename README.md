# nosql-challenge
the code for this challenge was written using course materials, tutor guidance and peer collaboration. 
I collaborated with Paola, Astrid and Zach on this project and therefore may have similarities in code.
